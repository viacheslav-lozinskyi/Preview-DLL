...
namespace resource.preview
{
    public class DLL : cartridge.AnyPreview
    {
        ...
        internal static void Send(atom.Trace context, int level, string pattern, string name, string value, string comment, string hint, string flag, string url)
        {
            context.
                Clear().
        ...
        internal static void Send(atom.Trace context, int level, string pattern, string name, UInt64 value, string comment, string hint, string flag, string url)
        {
            context.
                Clear().
                SetContent(GetCleanString(name)).
